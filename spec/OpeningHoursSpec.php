...
class OpeningHoursSpec extends ObjectBehavior
{
    ...
    public function it_can_be_open_some_days_only()
    {
    ...
    public function it_is_open_on_some_hours_only()
    {
    ...
    public function it_display_the_date_of_the_next_opening()
    {
    ...
    public function it_display_the_date_of_the_next_opening_in_the_same_day()
    {
