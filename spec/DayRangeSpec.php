...
class DayRangeSpec extends ObjectBehavior
{
    ...
    public function it_includes_some_days()
    {
    ...
    public function it_set_the_next_opening_day_to_false_if_range_is_empty()
    {
        $this->beConstructedWith([]);
        $this->getNextOpeningDay(new \DateTimeImmutable())->shouldReturn(false);
    }

    public function it_sets_the_next_opening_day_in_the_same_week()
    {
        $this->beConstructedWith([\Days::MONDAY, \Days::WEDNESDAY, \Days::FRIDAY]);
        $thursday = '2016-05-12T12:22:11.824Z';
    ...
    public function it_sets_the_next_opening_day_even_after_weekend()
    {
